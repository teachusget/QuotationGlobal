...
export default function AuditLogsPage() {
  ...
  return <section>
    <PageHeader eyebrow="Security" icon={ClipboardList} title="Audit Log" description="Dated history of successful and failed write actions across accounts, catalog, vendors, orders and marketplace management."/>
