...
import { clearAuth, readAuth, saveAuth } from './session'
...
export function AuthProvider({ children }) {
  ...
  const value = useMemo(() => ({ user, loading, isAuthenticated: Boolean(user), login, register, verifyEmail, logout }), [user, loading, login, register, verifyEmail, logout])
