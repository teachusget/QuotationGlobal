...
class RbacSeeder extends Seeder
{
    public const PERMISSIONS = [
        ...
        'vendors.view','vendors.create','vendors.update','vendors.delete','vendors.impersonate','customers.view','customers.update','customers.block','customers.unblock',
    ...
    public function run(): void
    {
        ...
        $vendor->syncPermissions(Permission::whereIn('name', ['vendors.view','customers.view','brands.view','services.view','services.create','services.update','services.delete','rfqs.view','rfqs.quote','demos.view','demos.update','messages.view','messages.send','purchase_orders.view','purchase_orders.send'])->get());
    }
}
